...
angular.module("orsApp").constant("orsNamespaces", {
  ...
  layerMapSurfer: {
    ...
    attribution:
      'Map data &copy; <a href="http://www.openstreetmap.org/">OpenStreetMap</a> contributors, powered by <a href="http://mapsurfernet.com/">MapSurfer.NET</a>'
  },
  ...
  layerOSM: {
    ...
    attribution:
      'Map data &copy; <a href="http://www.openstreetmap.org/">OpenStreetMap</a> contributors'
  },
  //url to OpenCycleMap
  layerOSMCycle: {
    url:
    ...
    attribution:
      'Maps &copy; <a href="http://thunderforest.com/">Thunderforest</a>, Data &copy; <a href="http://www.openstreetmap.org/">OpenStreetMap</a> contributors'
  },
  ...
  layerBkgTopPlus: {
    GetCapabilities:
      "http://sg.geodatenzentrum.de/wms_topplus_web_open?request=GetCapabilities&service=wms",
