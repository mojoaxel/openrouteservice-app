angular
  .module("orsApp.ors-aa-queries", [
    "orsApp.ors-aa-query",
    "orsApp.ors-export-query"
  ])
  .component("orsAaQueries", {
    templateUrl:
      "components/ors-panel-accessibilityanalysis/ors-aa-queries/ors-aa-queries.html",
    bindings: {},
    controller: [
      "$rootScope",
      "orsMessagingService",
      "orsAaService",
      function($rootScope, orsMessagingService, orsAaService) {
        let ctrl = this;
        ...
        $rootScope.isochronesSubscription = orsAaService.subscribeToAaQueries(
          function onNext(d) {
        ...
        ctrl.zoomTo = (isoidx, isonum = -1) => {
          let geometry;
          geometry =
            ctrl.aaQueries[isoidx].features[isonum].geometry.coordinates[0];
        ...
        ctrl.emph = (isoidx, isonum = -1) => {
          ...
          if (isonum > -1) {
            ...
            geometry =
              ctrl.aaQueries[isoidx].features[isolargest].geometry
                .coordinates[0];
          }
